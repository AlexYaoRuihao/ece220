...
EVALUATE
;IN: R0:INPUT R1:NEG_INPUT R2:OFFSET 
;R4 LOAD SIGNS
...
INER	
	...
	JSR KBINPUT
EXPZERO
	AND R0,R0,#0  	; IF R4 IS ZERO PUSH 1
	ADD R0,R0,#1
	JSR PUSH
	JSR KBINPUT
EXPONE 				; IF R4 IS ONE, PUSH R3 
	AND R0,R0,#0
	ADD R0,R0,R3
	JSR	PUSH
	JSR KBINPUT
