;General Intro Paragraph of MP2:
;This MP is a stack calculator that takes in postfix algebraic expression and
;compute its result. In general, I check the input character by character
;If the input is '=', then just simply skip and read next input. If the input
;is
;
.ORIG x3000
;;;
